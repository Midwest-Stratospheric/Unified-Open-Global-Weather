# UOGW Charts — 2026-09-15

Temperatures shown in **Fahrenheit (°F)**. Generated automatically from repository data.

_Generated at 2026-09-15T14:04:43Z UTC · Midwest Stratospheric Data Systems_
...
Today: **alert 0** · **watch 4** · **info 0** · total **4**
...
```mermaid
pie showData
  title Anomaly flags 2026-09-15
  "alert" : 0
  "watch" : 4
  "info" : 0
```
