# UOGW Charts — 2026-08-19

Temperatures shown in **Fahrenheit (°F)**. Generated automatically from repository data.

_Generated at 2026-08-19T08:06:13Z UTC · Midwest Stratospheric Data Systems_
...
Today: **alert 2** · **watch 2** · **info 0** · total **4**
...
```mermaid
pie showData
  title Anomaly flags 2026-08-19
  "alert" : 2
  "watch" : 2
  "info" : 0
```
