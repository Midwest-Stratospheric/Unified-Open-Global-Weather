# UOGW Charts — 2026-08-07

Temperatures shown in **Fahrenheit (°F)**. Generated automatically from repository data.

_Generated at 2026-08-07T09:43:53Z UTC · Midwest Stratospheric Data Systems_
...
Today: **alert 0** · **watch 5** · **info 0** · total **5**
...
```mermaid
pie showData
  title Anomaly flags 2026-08-07
  "alert" : 0
  "watch" : 5
  "info" : 0
```
